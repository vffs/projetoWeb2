            ...
            <div class="container-fluid">
                ...
                <form action="Cadastrar" method="post" >
                   ...
                   <div class="form-group">
                    ...
                    <option value="padrao" class="form-control" name="padrao" id="padrao">Usuario Padrão</option>
                    <option value="adm" class="form-control" name="adm" id="adm">Administrador</option>
                    
                    </select>
                    <small>Cadastre o Usuario Padrão para efetuar compras</small>    
                    </div>
                    <div class="form-group">
                        <label for="rua">Rua:</label>
                        <input type="text" class="form-control" name="rua" id="rua" maxlength="50" pattern="[A-Za-z\s]+" required value="Rua da Luz">
                    </div>
                    <div class="form-group">
                        <label for="num">Nº:</label>
                        <input type="number" class="form-control" name="num" id="num" required value="45">
                    </div>
			         
                    <div class="form-group">
                        <label for="comp">Complemento:</label>
                        <input type="text" class="form-control" name="comp" id="comp" maxlength="30" required value="perto da padaria">
                        <small>Ex.: Blobo B Apartamento 200</small>
                    </div>
			<div class="form-group">
                        <label for="cep">CEP:</label>
                        <input type="text" class="form-control" id="cep" name="cep" maxlength="10" pattern="[0-9]{5}-?[0-9]{3}" required value="55555-555">
                        <small>Ex.: 00000-000</small>
                    </div>     
                    <div class="form-group">
                        <label for="rua">Bairro:</label>
                        <input type="text" class="form-control" name="bairro" id="rua" maxlength="50" pattern="[A-Za-z\s]+" required value="Alegria">
                    </div>           
                    <div class="form-group">
                        <label for="cidade">Cidade:</label>
                        <input type="text" class="form-control" name="cidade" id="cidade" maxlength="50" pattern="[A-Za-z\s]+" required value="Paraiso">
                    </div>
                    <div class="form-group">
                        <label for="estado">Estado:</label>
                        <input type="text" class="form-control" name="estado" id="estado" maxlength="50" pattern="[A-Za-z\s]+" required value="Pernambuco">
                    </div>      
                    <div class="form-group">
                        <label for="fone">Telefone Fixo:</label>
                        <input type="text" class="form-control" name="fone" id="fone" maxlength="13" pattern="[(?[0-9]{2})?[0-9]{4}-?[0-9]{4}]" value="3333-3333">
                        <small>Ex.: (00)0000-0000 </small>
                    </div>               
                    <div class="form-group">
                        <label for="cel">Celular:</label>
                        <input type="text" class="form-control" name="cel" id="cel" maxlength="14" value="98888-22222">
